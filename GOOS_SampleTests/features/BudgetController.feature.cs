...
namespace GOOS_SampleTests.Features
{
	...
	public partial class BudgetControllerFeature
	{
		...
		public static void FeatureSetup(Microsoft.VisualStudio.TestTools.UnitTesting.TestContext testContext)
		{
			...
			var featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "BudgetController",
		...
		{
			var scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Add a budget record", ((string[]) (null)));
#line 4
...
#line 8
			testRunner.Then("ViewBag should have a message for adding successfully", ((string) (null)),
